...
Constant AGAIN1__WD     = 'again//~n';
Constant AGAIN2__WD     = 'g//~n';
Constant AGAIN3__WD     = 'again//~n';
Constant OOPS1__WD      = 'oops//~n';
Constant OOPS2__WD      = 'o//~n';
Constant OOPS3__WD      = 'oops//~n';
Constant UNDO1__WD      = 'undo//~n';
Constant UNDO2__WD      = 'undo//~n';
Constant UNDO3__WD      = 'undo//~n';
...
Constant NO1__WD        = 'n//~n';
Constant NO2__WD        = 'no//~n';
Constant NO3__WD        = 'no//~n';
Constant YES1__WD       = 'y//~n';
Constant YES2__WD       = 'yes//~n';
Constant YES3__WD       = 'yes//~n';

Constant AMUSING__WD    = 'amusing//~n';
Constant FULLSCORE1__WD = 'fullscore//~n';
Constant FULLSCORE2__WD = 'full//~n';
Constant QUIT1__WD      = 'q//~n';
Constant QUIT2__WD      = 'quit//~n';
Constant RESTART__WD    = 'restart//~n';
Constant RESTORE__WD    = 'restore//~n';
...
[ LanguageVerbIsDebugging w;
    if (w == 'purloin//~n' or 'tree//~n' or 'abstract//~n'
                       or 'gonear//~n' or 'scope//~n' or 'showobj//~n')
        rtrue;
    rfalse;
];
#Endif;
...
[ LanguageVerbLikesAdverb w;
  if (w == 'look//~n' or 'go//~n' or 'push//~n' or 'walk//~n')
        rtrue;
    rfalse;
];
...
[ LanguageVerbMayBeName w;
    if (w == 'long//~n' or 'short//~n' or 'normal//~n'
                    or 'brief//~n' or 'full//~n' or 'verbose//~n')
        rtrue;
    rfalse;
];
